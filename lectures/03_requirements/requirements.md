...
environment)
* Software is designed to sense and manipulate the environment into
...
1. Identify environmental entities and software/ML components
2. State a desired requirement (REQ) over the environment
3. Identify the interface between the environment & software
